...
class AddFamilyMemberDialog(context: Context, var pojoFamily: PojoFamily) : Dialog(context), View.OnClickListener, DialogInterface.OnDismissListener {
    var viewOnly = false
    var width = 0
        ...
        when (v.id) {
            R.id.Done -> {
                ...
                if (viewOnly) {
                    ...
                    contentValues.put(FamilyTable.isEmergencyContact, "0")
